      ...
      <div class="footer-links">
        ...
        <ul style="list-style: none; padding: 0; font-size: 0.9rem;">
          <li style="margin-bottom: 0.5rem;">
            <a href="https://portail-qualite.public.lu/fr.html" target="_blank" rel="noopener" style="color: white; opacity: 0.7; text-decoration: none;">Portail Qualité</a>
          </li>
          <li style="margin-bottom: 0.5rem;">
            <a href="https://www.uni.lu/snt-en/" target="_blank" rel="noopener" style="color: white; opacity: 0.7; text-decoration: none;">SnT - University of Luxembourg</a>
          </li>
          <li>
            <a href="archive-2021/index.html" style="color: white; opacity: 0.7; text-decoration: none; font-weight: bold;">
              Research Programme 2021-2024 (Archive)
            </a>
          </li>
        </ul>
      </div>
